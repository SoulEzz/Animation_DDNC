  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <Animated.View
        style={{
          opacity: box2_show,
          transform: [{ translateY: box2_run }],
        }}>
        <View
          style={{ transform: [{ translateX: 310 }, { translateY: -100 }] }}>
          <Text
            style={{
              width: 100,
              height: 100,
      ...
      <Animated.View
        style={{
          opacity: box3_show,
          transform: [{ translateX: box3_run }],
        }}>
        <View style={{ transform: [{ translateX: 310 }] }}>
          <Text
            style={{
              width: 100,
              height: 100,
